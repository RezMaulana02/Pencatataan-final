    ...
    <header class="px-4 py-2 shadow">
        <div class="flex justify-between">
            <div class="flex items-center">
                ...
                <button data-search class="p-4 md:hidden focus:outline-none hidden" type="button">
                ...
                <div data-search-form class="relative mr-3 hidden md:inline-block">
                    <form action="{{ route('search') }}" method="GET">
                        ...
                        <input type="text" name="query" placeholder="Search" class="h-auto pl-10 py-2 bg-gray-200 text-sm border border-gray-500 rounded-full focus:outline-none focus:bg-white">
                    </form>
                </div>
        ...
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-gray-900 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-gray-900">
                ...
                <a href="{{ route('admin/datauser') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Master Data_user</span>
                    </div>
                </a>
                <a href="{{ route('admin.payments.index') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Master Pembayaran</span>
                    </div>
                </a>
